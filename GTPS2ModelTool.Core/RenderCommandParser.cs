...
namespace GTPS2ModelTool.Core
{
    public class RenderCommandParser
    {
        ...
        {
            List<ModelSetupPS2Command> renderCommands = new List<ModelSetupPS2Command>();
                            ...
                            case ArgType.Byte:
                                {
                                    ...
                                    {
                                        if (!args[i].StartsWith("0x") || !byte.TryParse(args[i].Substring(2), NumberStyles.AllowHexSpecifier, null, out value))
                            ...
                            case ArgType.Int:
                                {
                                    ...
                                    {
                                        if (!args[i].StartsWith("0x") || !int.TryParse(args[i].Substring(2), NumberStyles.AllowHexSpecifier, null, out value))
                            ...
                            case ArgType.UInt:
                                {
                                    ...
                                    {
                                        if (!args[i].StartsWith("0x") || !uint.TryParse(args[i].Substring(2), NumberStyles.AllowHexSpecifier, null, out value))
        ...
        public static readonly Dictionary<string, RenderCommandDescription> Table = new()
        {
            ...
            { "AlphaFunction", new(ModelSetupPS2Opcode.pglAlphaFunc, new ArgType[] {
                    ArgType.String, ArgType.Byte
                }, ParseAlphaFunction)
            },

            { "AlphaFail", new(ModelSetupPS2Opcode.pglAlphaFail, new ArgType[] {
                    ArgType.String
                }, ParseAlphaFail)
            },

            { "BlendFunction", new(ModelSetupPS2Opcode.pglBlendFunc, new ArgType[] {
                    ArgType.Byte, ArgType.Byte, ArgType.Byte, ArgType.Byte, ArgType.Byte
                }, ParseBlendFunction)
            },

            { "ColorMask", new(ModelSetupPS2Opcode.pglColorMask, new ArgType[] {
                    ArgType.UInt
                }, ParseColorMask)
            },
            ...
            */
            ...
            { "DisableAlphaTest", new(ModelSetupPS2Opcode.pglDisableAlphaTest, new ArgType[] {

                }, null)
            },

            { "DisableCullFace", new(ModelSetupPS2Opcode.pglDisableCullFace, new ArgType[] {

                }, null)
            },

            { "DisableDepthMask", new(ModelSetupPS2Opcode.pglDisableDepthMask, new ArgType[] {
            ...
            */
            { "DestinationAlphaFunc", new(ModelSetupPS2Opcode.pglSetDestinationAlphaFunc, new ArgType[] {
                    ArgType.String
                }, ParseDestinationAlphaFunction)
            },

            { "EnableDestinationAlphaTest", new(ModelSetupPS2Opcode.pglEnableDestinationAlphaTest, new ArgType[] {
            ...
            { "FogColor", new(ModelSetupPS2Opcode.pglSetFogColor, new ArgType[] {
                    ArgType.UInt
                }, ParseFogColor)
            },

            { "DepthBias", new(ModelSetupPS2Opcode.pglDepthBias, new ArgType[] {
                    ArgType.Float
                }, ParseDepthBias)
            },
            ...
            */
            ...
            { "PushMatrix", new(ModelSetupPS2Opcode.pglPushMatrix, new ArgType[] {

                }, null)
            },

            { "PopMatrix", new(ModelSetupPS2Opcode.pglPopMatrix, new ArgType[] {

                }, null)
            },

            { "MatrixMode", new(ModelSetupPS2Opcode.pglMatrixMode, new ArgType[] {
                    ArgType.String
                }, ParseMatrixMode)
            },

            { "Rotate", new(ModelSetupPS2Opcode.pglRotate, new ArgType[] {
                    ArgType.Float, ArgType.Float, ArgType.Float, ArgType.Float,
                }, ParseRotate)
            },

            { "Translate", new(ModelSetupPS2Opcode.pglTranslate, new ArgType[] {
                    ArgType.Float, ArgType.Float, ArgType.Float,
                }, ParseTranslate)
            },

            { "Scale", new(ModelSetupPS2Opcode.pglScale, new ArgType[] {
                    ArgType.Float, ArgType.Float, ArgType.Float,
                }, ParseScale)
            },

            { "UnkGT3_3_1ui", new(ModelSetupPS2Opcode.pglGT3_3_1ui, new ArgType[] {
                    ArgType.Float,
                }, ParseUnkGT3_3_1ui)
            },

            { "UnkGT3_3_4f", new(ModelSetupPS2Opcode.pglGT3_3_4f, new ArgType[] {
                    ArgType.Float, ArgType.Float, ArgType.Float, ArgType.Float
                }, ParseUnkGT3_3_4f)
            },
        };

        private static ModelSetupPS2Command ParseAlphaFunction(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseBlendFunction(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseDestinationAlphaFunction(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            DestinationAlphaFunction tst = args[0].GetEnum<DestinationAlphaFunction>();
            return new Cmd_pglSetDestinationAlphaFunc(tst);
        }

        private static ModelSetupPS2Command ParseMatrixMode(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            MatrixMode mode = args[0].GetEnum<MatrixMode>();
            return new Cmd_pglMatrixMode(mode);
        }

        private static ModelSetupPS2Command ParseAlphaFail(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            AlphaFailMethod method = args[0].GetEnum<AlphaFailMethod>();
            return new Cmd_pglAlphaFail(method);
        }

        private static ModelSetupPS2Command ParseRotate(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseTranslate(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseScale(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            float x = args[0].GetFloat();
            float y = args[1].GetFloat();
            float z = args[2].GetFloat();
        ...
        private static ModelSetupPS2Command ParseFogColor(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            uint color = args[0].GetUInt();

            return new Cmd_pglSetFogColor(color);
        }

        private static ModelSetupPS2Command ParseDepthBias(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseColorMask(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
        ...
        private static ModelSetupPS2Command ParseUnkGT3_3_1ui(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            float color = args[0].GetFloat();

            return new Cmd_GT3_3_1ui(color);
        }

        private static ModelSetupPS2Command ParseUnkGT3_3_4f(RenderCommandDescription desc, RenderCommandArgument[] args)
        {
            ...
            return new Cmd_GT3_3_4f(r, g, b, a);
        }
    }
